...
//        LANCIA(true, false, fals
        MAZDA(true, false, true,47500.0,null,CarSegment.STANDARD,null,1.25),
        MERCEDES(true, false, true,630000.0,60000.0,CarSegment.PREMIUM,2300,1.9),
...
//        ROVER (true, false, false),
        SEAT(true, false, true,35000.0,null,CarSegment.STANDARD,null,0.9),
